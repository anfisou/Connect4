...
public class Board{
    ...
    public int line(){
        for(int i=0;i<6;i++){
        for(int j=0;j<4;j++){ 
            if (board[i][j] != 0 && board[i][j]==board[i][j+1] && board[i][j]==board[i][j+2] && board[i][j]==board[i][j+3]){return board[i][j];}
        }
        }
        return 0;
    }
    ...
    public int heuristic(){
        ...
        int p1=0;
        int p2=0;
        if(gameOver()==1){return -512;}
        if(gameOver()==2){return 512;}
        ...
        for(int i=0;i<6;i++){
            for(int j=0;j<4;j++){ 
                ...
                for(int k = 0;k<4;k++){
                    if(board[i][j+k]==1){p1++;}
                    else if(board[i][j+k]==2){p2++;}
                }
                if(p1==3 && p2==0){count-=50;}
                else if(p1==2 && p2==0){count -= 10;}
                else if(p1==1 && p2==0){count -= 1;}
                else if(p1==0 && p2==1){count += 1;}
                else if(p1==0 && p2==2){count += 10;}
                else if(p1==0 && p2==3){count += 50;}
            }
            }
            for(int j=0;j<7;j++){
                for(int i=0;i<3;i++){ 
                ...
                for(int i=0;i<3;i++){
                    for(int j=0;j<4;j++){ 
                        ...
                        p2=0;
                        for(int k = 0;k<4;k++){
                            if(board[i+k][j+k]==1){p1++;}
                            else if(board[i+k][j+k]==2){p2++;}
                        }
                        if(p1==3 && p2==0){count-=50;}
                        else if(p1==2 && p2==0){count -= 10;}
                        else if(p1==1 && p2==0){count -= 1;}
    ...
    public boolean canInsert(int coord){
        if(coord<0 || coord>6){return false;}
    ...
    public Board insert(int coord){
        ...
        b = copy();
        for(int k = 0;k<6;k++){
            if(b.board[k][coord]==0){b.board[k][coord] = player;break;}
        }
        return b;
    }
        ...
        if(max){
            ...
            for(int j=0;j<7;j++){
                if(canInsert(j)){
                    ...
                    if(value>maxv){maxv=value;jogada=j;}
                }
            }
            res[0]=jogada;
            res[1]=maxv;
            ...
            for(int j=0;j<7;j++){
                if(canInsert(j)){
                    ...
                    if(value<minv){minv=value;jogada=j;}
                }
            }
            res[0]=jogada;
            res[1]=minv;
